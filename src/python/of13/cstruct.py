...
class ofp_aggregate_multipart_reply(object):
    """Automatically generated Python class for ofp_aggregate_multipart_reply
...
class ofp_table_multipart(object):
    """Automatically generated Python class for ofp_table_multipart
...
class ofp_group_multipart(object):
    """Automatically generated Python class for ofp_group_multipart
...
class ofp_queue_multipart(object):
    """Automatically generated Python class for ofp_queue_multipart
...
class ofp_port_multipart_request(object):
    """Automatically generated Python class for ofp_port_multipart_request
...
class ofp_group_multipart_request(object):
    """Automatically generated Python class for ofp_group_multipart_request
...
class ofp_aggregate_multipart_request(object):
    """Automatically generated Python class for ofp_aggregate_multipart_request
...
class ofp_action_output(object):
    ...
    def show(self, prefix=''):
        ...
        outstr += prefix + 'type: ' + str(self.type) + '\n'
        outstr += prefix + 'len: ' + str(self.len) + '\n'
        outstr += prefix + 'port: ' + '0x%0.8X' % self.port + '\n'
...
class ofp_action_experimenter_header(object):
    ...
    def pack(self, assertstruct=True):
        ...
        if(assertstruct):
            if(not self.__assert()[0]):
                return None
        packed = ""
        packed += struct.pack("!HHLB", self.type, self.len, self.experimenter, self.action)
        packed += struct.pack("!BBB", self.reserved[0], self.reserved[1], self.reserved[2])
        if self.len == 16:
           packed += struct.pack("!L", self.payload)
        elif self.len == 24:
           packed += struct.pack("!Q", self.payload)
           packed += struct.pack("!BBBB", self.pad[0], self.pad[1], self.pad[2], self.pad[3])
        return packed
    ...
    def show(self, prefix=''):
        ...
        outstr += prefix + 'type: ' + str(self.type) + '\n'
        outstr += prefix + 'len: ' + str(self.len) + '\n'
        outstr += prefix + 'experimenter: ' + '0x%0.8X' % self.experimenter + '\n'
	outstr += prefix + 'action: ' + str(self.action) + '\n'
        if self.len == 16:
           outstr += prefix + 'payload: ' + '0x%0.8X' % self.payload + '\n'
        elif self.len == 24:
           outstr += prefix + 'payload: ' + '0x%0.16X' % self.payload + '\n'
        return outstr
...
class ofp_flow_multipart(object):
    """Automatically generated Python class for ofp_flow_multipart
...
class ofp_queue_multipart_request(object):
    """Automatically generated Python class for ofp_queue_multipart_request
...
class ofp_group_features_multipart(object):
    """Automatically generated Python class for ofp_group_features_multipart
...
class ofp_port_multipart(object):
    """Automatically generated Python class for ofp_port_multipart
...
class ofp_flow_multipart_request(object):
    """Automatically generated Python class for ofp_flow_multipart_request
...
class ofp_desc_multipart(object):
    """Automatically generated Python class for ofp_desc_multipart
...
# TODO: expand the code below
class ofp_group_features_multipart(object):
    pass


class ofp_group_desc_multipart(object):
    """Automatically generated Python class for ofp_group_desc_multipart
...
ofp_experimenters_field = ['OFPXMT_TLAB_GMPLS_SWCAPENCTYPE', 'OFPXMT_TLAB_GMPLS_SIGTYPE', 'OFPXMT_TLAB_GMPLS_LABEL']
OFPXMT_TLAB_GMPLS_SWCAPENCTYPE = 1
OFPXMT_TLAB_GMPLS_SIGTYPE = 2       
OFPXMT_TLAB_GMPLS_LABEL = 3
ofp_experimenters_field_map = {
    1                               : 'OFPXMT_TLAB_GMPLS_SWCAPENCTYPE',
    2                               : 'OFPXMT_TLAB_GMPLS_SIGTYPE',
    3                               : 'OFPXMT_TLAB_GMPLS_LABEL'
}

ofp_tlab_action = ['OFPXMT_TLAB_GMPLS_LABEL']
OFPXMT_TLAB_GMPLS_LABEL = 3
ofp_tlab_action = {
    3                               : 'OFPXMT_TLAB_GMPLS_LABEL'
}
...
ofp_multipart_types = ['OFPMP_DESC', 'OFPMP_FLOW', 'OFPMP_AGGREGATE', 'OFPMP_TABLE', 'OFPMP_PORT', 'OFPMP_QUEUE', 'OFPMP_GROUP', 'OFPMP_GROUP_DESC', 'OFPMP_GROUP_FEATURES', 'OFPMP_METER', 'OFPMP_METER_CONFIG', 'OFPMP_METER_FEATURES', 'OFPMP_TABLE_FEATURES', 'OFPMP_PORT_DESC', 'OFPMP_EXPERIMENTER']
OFPMP_DESC                          = 0
OFPMP_FLOW                          = 1
OFPMP_AGGREGATE                     = 2
OFPMP_TABLE                         = 3
...
OFP_AGGREGATE_MULTIPART_REPLY_BYTES = 24
OFP_AGGREGATE_MULTIPART_REQUEST_BYTES = 36
OFP_BUCKET_BYTES = 16
OFP_BUCKET_COUNTER_BYTES = 16
OFP_DESC_MULTIPART_BYTES = 1056
...
OFP_FLOW_MULTIPART_BYTES = 52
OFP_FLOW_MULTIPART_REQUEST_BYTES = 36
OFP_GROUP_DESC_MULTIPART_BYTES = 8
OFP_GROUP_FEATURES_MULTIPART_BYTES = 40
OFP_GROUP_MOD_BYTES = 8
OFP_GROUP_MULTIPART_BYTES = 32
OFP_GROUP_MULTIPART_REQUEST_BYTES = 8
OFP_HEADER_BYTES = 8
OFP_HELLO_BYTES = 0
...
OFP_PORT_MULTIPART_BYTES = 104
OFP_PORT_MULTIPART_REQUEST_BYTES = 8
...
OFP_QUEUE_MULTIPART_BYTES = 32
OFP_QUEUE_MULTIPART_REQUEST_BYTES = 8
