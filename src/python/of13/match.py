...
class oxm_tlv(object):
    def __init__(self, field, hasmask, length, value, value2=None, mask=None,
        class_=0x8000):
        self.class_ = class_
        self.field = field
	...
	self.value2 = value2
        self.mask = mask
	self.experimenter_id = 0x0000B0C7
	...
	if self.class_ == 0x8000:
	        ...
	        packed += struct.pack("!I", self.experimenter_id)
		if self.length == 8 and self.value2 == None:
			packed += struct.pack("!I", self.value)
                elif self.length == 12 and self.value2 == None:
                        packed += struct.pack("!Q", self.value)
		else:
			packed += struct.pack("!B", self.value)	
	        if self.value2 != None:
	                packed += struct.pack("!B", self.value2)
        return packed
    ...
    def show(self, prefix=''):
        outstr = prefix + "oxm_tlv_class= " + hex(self.class_) + "\n"
        outstr += prefix + "oxm_tlv_field= " + str(self.field) + "\n"
        outstr += prefix + "oxm_tlv_hasmask= " + str(bool(self.hasmask)) + "\n"
        outstr += prefix + "oxm_tlv_length= " + str(self.length) + "\n"
        if self.class_ != 0x8000:
           outstr += prefix + "oxm_experimenter_id= " + '0x%0.8X' % self.experimenter_id + "\n"
...
class in_port(oxm_tlv):
    ...
    def show(self, prefix=''):
        ...
        outstr += prefix + "value = " + '0x%0.8X' % self.value + "\n"
        return outstr
...
class mpls_bos(oxm_tlv):
    ...
    def show(self, prefix=''):
        outstr = prefix + "name = mpls_bos\n"
        outstr += oxm_tlv.show(self, prefix)
        outstr += prefix + "value = " + str(self.value) +"\n"
        return outstr

class swcapenctype(oxm_tlv):
    """
    Wrapper class for swcapenctype match object
    ...
    """
    def __init__(self, value1=None, value2=None, hasmask=False):
        oxm_tlv.__init__(self, OFPXMT_TLAB_GMPLS_SWCAPENCTYPE, hasmask, 6, value1, value2, class_=0xFFFF)

    def show(self, prefix=''):
        outstr = prefix + "name = SWCAPENCTYPE\n"
        outstr += oxm_tlv.show(self, prefix)
        outstr += prefix + "value 1 = " + str(self.value) +"\n"
        outstr += prefix + "value 2 = " + str(self.value2) +"\n"
        return outstr

class sigtype(oxm_tlv):
    """
    Wrapper class for sigtype match object
    ...
    """
    def __init__(self, value=None, hasmask=False):
        oxm_tlv.__init__(self, OFPXMT_TLAB_GMPLS_SIGTYPE, hasmask, 5, value, class_=0xFFFF)
    def show(self, prefix=''):
        outstr = prefix + "name = SIGTYPE\n"
        outstr += oxm_tlv.show(self, prefix)
        outstr += prefix + "value = " + str(self.value) +"\n"
        return outstr
...
class label(oxm_tlv):
    """
    Wrapper class for label match object
    ...
    """
    def __init__(self, value=None, hasmask=False):
        oxm_tlv.__init__(self, OFPXMT_TLAB_GMPLS_LABEL, hasmask, 8, value, class_=0xFFFF)
    def show(self, prefix=''):
        outstr = prefix + "name = LABEL\n"
        outstr += oxm_tlv.show(self, prefix)
        outstr += prefix + "value = " + '0x%0.8X' % self.value +"\n"
        return outstr

class non_ho_odu_label(oxm_tlv):
    """
    Wrapper class for non_ho_odu_label match object
    ...
    """
    def __init__(self, value=None, hasmask=False):
        oxm_tlv.__init__(self, OFPXMT_TLAB_GMPLS_LABEL, hasmask, 12, value, class_=0xFFFF)
    def show(self, prefix=''):
        outstr = prefix + "name = NON HO ODU LABEL\n"
        outstr += oxm_tlv.show(self, prefix)
        outstr += prefix + "value = " + '0x%0.16X' % self.value +"\n"
        return outstr
