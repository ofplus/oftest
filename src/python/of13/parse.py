...
multipart_reply_to_class_map = {
    ofp.OFPMP_DESC                      : message.desc_multipart_reply,
    ofp.OFPMP_FLOW                      : message.flow_multipart_reply,
    ofp.OFPMP_AGGREGATE                 : message.aggregate_multipart_reply,
    ofp.OFPMP_TABLE                     : message.table_multipart_reply,
    ofp.OFPMP_PORT                      : message.port_multipart_reply,
    ofp.OFPMP_QUEUE                     : message.queue_multipart_reply,
    ofp.OFPMP_GROUP                     : message.group_multipart_reply,
    ofp.OFPMP_GROUP_DESC                : message.group_desc_multipart_reply,
#    ofp.OFPMP_GROUP_FEATURES            : message.group_features_multipart_reply,
#    ofp.OFPMP_METER                     : message.meter_multipart_reply,
#    ofp.OFPMP_METER_CONFIG              : message.meter_config_multipart_reply,
#    ofp.OFPMP_METER_FEATURES            : message.meter_features_multipart_reply,
#    ofp.OFPMP_TABLE_FEATURES            : message.table_features_multipart_reply,
    ofp.OFPMP_PORT_DESC                 : message.port_desc_multipart_reply,
#    ofp.OFPMP_EXPERIMENTER
}

multipart_request_to_class_map = {
    ofp.OFPMP_DESC                      : message.desc_multipart_request,
    ofp.OFPMP_FLOW                      : message.flow_multipart_request,
    ofp.OFPMP_AGGREGATE                 : message.aggregate_multipart_request,
    ofp.OFPMP_TABLE                     : message.table_multipart_request,
    ofp.OFPMP_PORT                      : message.port_multipart_request,
    ofp.OFPMP_QUEUE                     : message.queue_multipart_request,
    ofp.OFPMP_GROUP                     : message.group_multipart_request,
    ofp.OFPMP_GROUP_DESC                : message.group_desc_multipart_request,
#    ofp.OFPMP_GROUP_FEATURES            : message.group_features_multipart_request,
#    ofp.OFPMP_METER                     : message.meter_multipart_request,
#    ofp.OFPMP_METER_CONFIG              : message.meter_config_multipart_request,
#    ofp.OFPMP_METER_FEATURES            : message.meter_features_multipart_request,
#    ofp.OFPMP_TABLE_FEATURES            : message.table_features_multipart_reqest,
    ofp.OFPMP_PORT_DESC                 : message.port_desc_multipart_request,
#    ofp.OFPMP_EXPERIMENTER
}
